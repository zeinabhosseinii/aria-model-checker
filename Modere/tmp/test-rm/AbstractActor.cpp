...
#ifdef SYMM
void AbstractActor::marshalVariablesToArrayWithPerm(byte* array, byte* perm) {
    marshalVariablesToArray(array);
}
void AbstractActor::marshalParamsWithPerm(byte* output, byte* params, byte msgType, byte* perm) {
