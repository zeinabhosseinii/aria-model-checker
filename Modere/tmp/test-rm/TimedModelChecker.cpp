...
bool TimedModelChecker::areActiveActionsSafe(byte* state, int r, int propertySelector) {
	static bool safeActions[REBEC_COUNT][3] = {
		{ true, true, false },
	...
	return safeActions[r][rebecs[r]->messageQueue[0]];
}
